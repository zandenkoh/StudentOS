    ...
    prompt: JSON.stringify(
      {
        ...
        requirements: [
          ...
          "If one sourceTruthPacket contains one broad learning goal, return exactly one commitment of type='goal' for it. Put prerequisites, sub-skills, milestones, practice sessions, and curriculum chunks in roadmapSteps or planTasks, never as separate goal commitments.",
          ...
          "Never create a commitment whose title is exactly a filename (e.g., IMG-..., .jpg, .pdf) or 'uploaded source'. Extract the actual task from the interpretedItems or evidence.",
          "Do not create duplicate commitments for the same underlying action. If a source packet provides the same task in interpretedItems, extractedTasks, and evidenceText, merge them into a single commitment.",
          "If a source packet has a filename as its title, only extract commitments from its interpretedItems, extractedTasks, or evidenceText, and do not extract the filename itself as a task.",
          ...
          "When exaGoalResearch is present, do not treat it as a summary add-on. Use it to change planning decisions: clarification questions, first milestone, cadence, workload estimate, deliverables, risks, and today's scheduled task.",
          "When exaGoalResearch names prerequisites, criteria, deadlines, deliverables, eligibility, or common failure points, at least one clarification question or roadmap task must reflect that concrete finding.",
          ...
          "Do not create generic roadmap tasks like 'research the goal' when exaGoalResearch already contains the context. Use the checked context to schedule the next real action.",
